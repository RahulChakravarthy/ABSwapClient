...
import com.hacks.radish.util.GlideApp
...
class PercentageFilterView : View {
    ...
    private fun init(attrs: AttributeSet) {
        inflate(context, com.hacks.radish.R.layout.view_percentage_filter, viewPercentageLayout)

        val attributes = context.obtainStyledAttributes(attrs, com.hacks.radish.R.styleable.PercentageFilterView)
        attributes.recycle()
    }
